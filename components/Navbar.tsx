      ...
      <nav className="mx-auto flex h-16 max-w-content items-center justify-between px-5 md:h-20 md:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="-ml-2 flex h-12 w-12 items-center justify-center md:hidden"
          >
        ...
        {menuOpen && (
          ...
          >
              ...
              {LINKS.map((link, i) => (
                ...
                >
                  <Link
                    href={link.href}
                    onClick={() => setMenuOpen(false)}
                    className="font-display text-3xl font-light text-linen"
                  >
                    {link.label}
                  </Link>
                </motion.li>
            ...
            <Link
              href="/reservations"
              onClick={() => setMenuOpen(false)}
              className="mt-auto flex h-14 items-center justify-center rounded-full bg-gold font-sans text-base font-medium text-forest"
            >
              Reserve a Table
            </Link>
          </motion.div>
